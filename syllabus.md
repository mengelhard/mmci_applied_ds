...
## Respect, Trust, and Inclusion Statement
The MMCi Program is designed to produce the next generation of clinical informatics leaders grounded in sound ethical and scientific principles. Central among these are principles of respect, trust, and inclusion, which will enhance our students' ability to improve human health effectively for all. We affirm principles of respect, trust, and inclusion put forth by the Duke University School of Medicine and Department of Biostatistics & Bioinformatics, and we are committed to proactively fostering an inclusive environment in which a wide range of perspectives and backgrounds are welcome and thrive. This range of perspective and background is particularly critical in machine learning to ensure that decision-making algorithms are used ethically and promote improved health outcomes for everyone. We are always looking for ways to make course content more inclusive, and encourage students with recommendations or concerns related to trust, respect, and inclusion in the course content to contact the course director.
