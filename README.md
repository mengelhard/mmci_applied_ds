...
1 | Intro to Health DS | AL1: Logistic Regression<br>AL2: Multilayer Perceptron | Course Intro and Materials<br>LL1: Intro to Health DS<br>Coding/Python Resources<br>[Discussion](https://github.com/mengelhard/mmci_applied_ds/blob/master/quizzes/block1.md)<br>LL2: DS Principles and Culture | - [Quiz 2: Medical Image Analysis](https://github.com/mengelhard/mmci_applied_ds/blob/master/quizzes/block2.md)<br>- [CA 1: Predicting Clinic No-Shows](https://github.com/mengelhard/mmci_applied_ds/blob/master/notebooks/block1_noshows_noncoding.ipynb)
