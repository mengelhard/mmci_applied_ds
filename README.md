...
--- | --- | --- | ---
1: Evaluating Predictive Models | - Review Course Site<br>- Read [Obermeyer and Emanuel](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5070532/)<br>- Read [Chen and Asch](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5953825/)<br>- Complete [Quiz 1](quizzes/q1.md) in Sakai | *Asynchronous*<br>- [AL1: Predictive Models](lectures/al1.pdf)<br>- [AL2: Logistic Regression](lectures/al2.pdf)<br><br>*Saturday*<br>- Lecture: [Intro to Health DS](lectures/ll1.pdf)<br>- Activity: [Understanding Logistic Regression](activities/logistic_regression.pdf)<br>- Lecture: [Performance Measures](lectures/ll3.pdf)<br>- Activity: [Calculating Performance](activities/psa_performance.xlsx) | *Model Development Pathway*<br>- [CE1: Welcome to the Jupyter Notebook](notebooks/ce1.ipynb)<br>- [CE2: Visualizing Features of Breast Cancer Samples](notebooks/ce2.ipynb)<br><br>*Model Evaluation Pathway*<br>- Evaluate [Khera et al., 2021](https://jamanetwork.com/journals/jamacardiology/fullarticle/2777055)
